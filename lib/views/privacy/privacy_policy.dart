import 'package:comment1/views/privacy/privacy_policy_ctrl.dart';
  ...
  build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (PrivacyPolicyCtrl ctrl) => Scaffold(
        appBar: AppBar(
          title: Text("隐私政策",style: TextStyle(fontSize: 18.sp,fontWeight: FontWeight.w600,color:Colors.black)),
          centerTitle: true,
        ),
